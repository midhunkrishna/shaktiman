...
- **Structural changes warrant an ADR.** If you're changing an interface, swapping
  ...
  description; see the [existing ADRs](/design/adr-001-code-review) for how they're
  structured.
...
- ADR index — [ADR-001](/design/adr-001-code-review), [ADR-002](/design/adr-002-multi-instance),
  [ADR-003](/design/adr-003-pluggable-backends), [ADR-004](/design/adr-004-recursive-chunking)
  — decisions you'll want context on before making structural changes.
